...
class PrivacyArguments:
    ...
    min_separation: int = field(default=None)
    torch_seed_is_fixed: bool = field(default=1)
    noise_offload: bool = field(default=0)
    noise_partition: int = field(default=1)
    GPU_partition: int = field(default=1)
    CPU_partition: int = field(default=0)
    speed_mode: bool = field(default=False, metadata={"help": "Skip BandMF factorization; use random banded matrix for timing benchmarks."})
